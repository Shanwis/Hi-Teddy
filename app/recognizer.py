...
recognizer = KaldiRecognizer(model,SAMPLE_RATE, '["open", "terminal", "browser", "shutdown", "reboot", "lock", "screen", "cancel", "close", "window", "speaker", "up", "down","increase","decrease","volume","mute","unmute","speaker", "brightness", "battery", "power", "level", "internet", "on", "off", "bluetooth","reduce", "editor", "stop", "assistant"]')
